...
<ul >
    ...
    <div class="row">
        ...
        <div class="column">
          <div class="card">
            <img src="images/d5.jpg" width='353' height='264'alt="krupal.v" style="width:100%">
            <div class="container">
            <?php
              echo '<b>'.$name[0].'<br>'.'Price :&nbsp;' .$price[0].'</b>&nbsp;&nbsp;<del>'.$oprice[0].'</del><br>'.$ing[0].'<br>';
              ?> 
<form action=''method="post"> 
            <label for="quantity">Qnty :</label>  <input type='number' name='quantity' min='1' value='1'>              <button type="submit" name="button" class='button' value='0'> cart</button>
          </form> 
            </div>
          </div>
        </div>
        ...
        <div class="column">
          <div class="card">
            <img src="images/d6.jpg" width='353' height='264'alt="kush" style="width:100%">
            <div class="container">
            <?php
              echo '<b>'.$name[1].'<br>'.'Price :&nbsp;' .$price[1].'</b>&nbsp;&nbsp;<del>'.$oprice[1].'</del><br>'.$ing[1].'<br>';
              ?> 
<form action=''method="post"> 
            <label for="quantity">Qnty :</label>  <input type='number' name='quantity' min='1' value='1'>              <button type="submit" name="button" class='button' value='1'> cart</button>
          </form> 
            </div>
          </div>
        </div>
        ...
        <div class="column">
          <div class="card">
            <img src="images/d4.jpg" width='353' height='264'alt="yash" style="width:100%">
            <div class="container">
            <?php
              echo '<b>'.$name[2].'<br>'.'Price :&nbsp;' .$price[2].'</b>&nbsp;&nbsp;<del>'.$oprice[2].'</del><br>'.$ing[2].'<br>';
              ?> 
<form action=''method="post"> 
            <label for="quantity">Qnty :</label>  <input type='number' name='quantity' min='1' value='1'>              <button type="submit" name="button" class='button' value='2'> cart</button>
          </form> 
            </div>
          </div>
        </div>
      ...
      <p>Go to :&nbsp;
        <a style='text-align:center' href="pizza.php">Pizza</a><label>&nbsp;or
        </label>
        <a href="garlic.php">Garlic Bread</a></p>
</body>
</html>