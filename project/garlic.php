...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <div class="row">
        ...
        <div class="column">
          <div class="card">
            <img src="images/g1.jpeg" width='353' height='264'alt="krupal.v" style="width:100%">
            <div class="container">
            <?php
        ...
        <div class="column">
          <div class="card">
            <img src="images/g2.jpg" width='353' height='264'alt="kush" style="width:100%">
            <div class="container">
            <?php
        ...
        <div class="column">
          <div class="card">
            <img src="images/g3.jpg" width='353' height='264'alt="yash" style="width:100%">
            <div class="container">
            <?php
      ...
      <div class="row">
        ...
        <p>Go to :&nbsp;
        <a style='text-align:center' href="pizza.php">Pizzas</a><label>&nbsp;or
        </label>
